    ...
    if (!users.length) {
        ...
        chatList.innerHTML = `
            <div class="empty-chat-list">
                <div class="empty-list-icon">🔎</div>
                <strong>کاربری پیدا نشد</strong>
                <span>نام یا نام کاربری دیگری را امتحان کنید.</span>
            </div>
        `;
    ...
    users.forEach(user => {
        ...
        item.innerHTML = `
            ...
            <div class="search-user-info">
                ...
                <strong>
                    ${escapeSearchHtml(user.name)}
                    ${
                        user.premium_level > 0
                            ? ' <span class="search-premium">💎</span>'
                            : ''
                    }
                </strong>

                <span>
                    @${escapeSearchHtml(user.username)}
                </span>
...
function showUserProfile(user) {
    ...
    profile.innerHTML = `
        ...
        <div class="profile-body">
            ...
            <button
                class="primary-button profile-message-button"
                type="button"
                onclick="startRealChat('${escapeSearchHtml(user.username)}')"
            >
                💬 پیام دادن
            </button>
...
function startRealChat(username) {
